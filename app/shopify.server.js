...
import {registerSealSubscriptionWebhook} from './registerSealSubscriptionWebhook'

dotenv.config();

dbconnection();

registerSealSubscriptionWebhook()
...
const shopify = shopifyApp({
  ...
  sessionStorage:
    process.env.NODE_ENV === "production"
      ...
      : new MongoDBSessionStorage("mongodb://127.0.0.1:27017", "pd_builder"),
